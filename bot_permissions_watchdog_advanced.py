...
class BotPermissionsWatchdogAdvanced:
    ...
    async def _notify_permission_lost(
        ...
        text = (
            ...
            f"Бот потерял права администратора в:\n"
            f"<b>{chat_title}</b>\n\n"
            ...
            f"<b>Действие:</b>\n"
            f"1️⃣ Добавьте бота администратором\n"
            f"2️⃣ Проверьте права (кнопка ниже)\n"
            f"3️⃣ Или отмените задание\n\n"
    ...
    async def _notify_task_deleted(
        ...
        text = (
            ...
            f"Для создания нового задания добавьте бота администратором."
        )

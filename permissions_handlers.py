...
async def check_permissions_callback(
    ...
    if has_permissions:
        ...
        text = (
            ...
            f"2. Есть ли у бота права на:\n"
            f"   • Отправку сообщений\n"
...
async def help_bot_admin_callback(callback: CallbackQuery):
    ...
    text = (
        ...
        "6. Убедитесь, что установлены права:\n"
        "   ✓ Удаление сообщений\n"
...
async def _check_bot_permissions(
    ...
    required = ["can_post_messages", "can_edit_messages", "can_delete_messages", "can_invite_users"]
